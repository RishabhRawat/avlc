...
// Universal types.
    ...
    const Iir_Integer_Type_Definition Universal_Integer_Type_Definition;
    ...
    const Iir_Floating_Type_Definition Universal_Real_Type_Definition;
...
//  universal cannot.
    const Iir_Integer_Type_Definition Convertible_Integer_Type_Definition;
    const Iir_Floating_Type_Definition Convertible_Real_Type_Definition;
...
//  Chain of wildcard declarations, to own the nodes.
    Iir Wildcard_Type_Declaration_Chain;
