...
const Iir_Integer_Type_Definition Universal_Integer_Type_Definition = 3;
const Iir_Floating_Type_Definition Universal_Real_Type_Definition = 4;

const Iir_Integer_Type_Definition Convertible_Integer_Type_Definition = 5;
const Iir_Floating_Type_Definition Convertible_Real_Type_Definition = 6;

Options options;

void Add_Decl (Iir*  Decl : Iir) is
        begin
